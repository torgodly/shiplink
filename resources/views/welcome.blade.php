<x-app-layout>
            ...
            <div class="navbar-nav me-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        <a href="#Pricing_Plan" class="dropdown-item">خطط التسعير</a>
                ...
                <div class="container">
                    <div class="row justify-content-start" dir="rtl">
                        <div class="col-10 col-lg-8">
                            ...
                            <a href="#Pricing_Plan" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">احسب سعر
                                شحنتك</a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Pricing Start -->
    <div class="container-xxl py-5" id="Pricing_Plan">
        <div class="container py-5">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
