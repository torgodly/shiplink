...
use App\Filament\Office\Resources\ReceivedPackagesResource\Pages;
...
//                    ->download('test')
    ...
    {
        return parent::getEloquentQuery()->where('receiver_branch_id', \Auth::user()->mangedbrance?->id);
    }
